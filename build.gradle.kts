...
loom {
    ...
    forge {
        ...
        mixinConfig("mixins.moonlight.json")

    }
    @Suppress("UnstableApiUsage")
    mixin {
        defaultRefmapName.set("mixins.moonlight.refmap.json")
    }
}
...
tasks {
    ...
    withType(Jar::class) {
        ...
        manifest.attributes.run {
            ...
            this["MixinConfigs"] = "mixins.moonlight.json"
        }
    }
